...
| Destination Location | destination.geo.country_name | |
| FUTURE_USE | | | removed
| Content Type | | panw.content_type |
| PCAP_ID | | panw.PCAP_ID |
| File Digest | | panw.file_digest |
| Cloud | cloud.provider | |
| URL Index | url.index | |
| User Agent | | panw.user_agent | 
| File Type | | panw.file_type |
| X-Forwarded-For | | panw.X_forwarded_for |
| Referer | | panw.referrer |
| Sender | | panw.sender |
...
| IPv6 Source Address | source.ip.v6 | | proposed extention to ecs
| Host ID | host.id | |
|==============
